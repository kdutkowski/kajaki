...
\end{figure}
Wyznaczamy przecodnie domknięcie z jednym skokiem grafu $G'$
\begin{figure}[H]
  \caption{Graf $G$}
  \centering
...
W grafie $G$ szukamy skojarzenia. Może to być na przykład
\begin{lstlisting}[title=Możliwe skojarzenie]
1 6	3 5
2 3	1 6
5 4	2 6
\end{lstlisting}
Po usunięciu wybranych wierzhcołków pozostaje nam tylko jeden 
wierzchołek $5|6$.
